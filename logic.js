    ...
    for(let r=0; r<rows; r++){
        ...
        for(let c = 0; c<columns; c++){
            ...
            if(originalRow[c] !== num && num !== 0 ){
                ...
                tile.style.animation = "slide-from-right 0.5s";
    ...
    for(let r=0; r<rows; r++){
        ...
        for(let c = 0; c<columns; c++){
            ...
            if(originalRow[c] !== num && num !== 0 ){
                ...
                tile.style.animation = "slide-from-left 0.5s";
    ...
    for(let c=0; c<columns; c++){
        ...
        for(let r=0; r<rows; r++){
            ...
            if(changedIndices.includes(r) && num !== 0) {
                ...
                tile.style.animation = "slide-from-bottom 0.5s";
...
function slideDown(){
    for(let c=0; c<columns; c++){
        ...
        // check which tiles have changed its position
        let changedIndices =[]; // This variable and loop will record the position of the tiles that changed
        for (let r=0; r<rows; r++){
...
// This will listen to when we touch the screen and assigns the x and y coordinates 
...
// Inputs targets any element that includes the word tile in their class
